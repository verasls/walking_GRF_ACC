...
ankle_pVGRF_pVACC__plot <- ggplot(data = LOOCV_ankle_vert) +
  geom_point(mapping = aes(x = pVGRF_N, y = pVACC_g, shape = BMI_cat))
...
ankle_pRGRF_pRACC_plot <- ggplot(data = LOOCV_ankle_res) +
  geom_point(mapping = aes(x = pRGRF_N, y = pRACC_g, shape = BMI_cat))
...
ankle_pred_pVGRF_pVACC_plot <- ggplot(data = LOOCV_ankle_vert) +
  geom_point(mapping = aes(x = pVGRF_N_predicted, y = pVACC_g, shape = BMI_cat))
...
ankle_pred_pRGRF_pRACC_plot <- ggplot(data = LOOCV_ankle_res) +
  geom_point(mapping = aes(x = pRGRF_N_predicted, y = pRACC_g, shape = BMI_cat))
