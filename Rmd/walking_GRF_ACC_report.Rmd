...
For lower back and hip placements, results showed a significant proportional bias (*p* < 0.05), however, with a low magnitude (highest R^2^ = 0.032). These results suggest that despite there is a trend for underestimation at increasingly higher pGRF values, the magnitude of this effect is neglectable.
...
```{r ANOVA_plot, fig.height=10, fig.width=10, dev='svg'}
